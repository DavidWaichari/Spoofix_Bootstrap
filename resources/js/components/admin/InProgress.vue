...
<script lang="ts" setup>
  ...
  const router = useRouter();
      ...
      const headers: Header[] = [
        { text: "Domain safeguarded", value: "report_form.spoof_domain.domain.name", sortable: true },
        { text: "Domain reported", value: "report_form.spoof_domain.name" , sortable: true },
        { text: "Organization", value: "reporting_organization.name" , sortable: true },
        { text: "Mode", value: "reporting_mode" , sortable: true },
        { text: "Repoted by", value: "reported_by.name" , sortable: true },
        { text: "Reported on", value: "created_at", sortable: true },
      ...
      const loadData = async () =>{
        const response = await axios.get(`/api/domain_reports`);
        items.value = response.data.data.domain_reports
        loading.value = false;
